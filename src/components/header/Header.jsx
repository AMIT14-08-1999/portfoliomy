...
const nameArray = ['m', 'i', 't', 'G', 'h', 'o', 's', 'h']
const jobArray = [
  's',
  'o',
  'f',
    ...
    <>
      <section className="section-1 header__container section__padding">
        <main className="intro-page">
          <h1 arial-label="Hi i'm Amit, web Junior full-stack developer">
          ...
          <p className="text-desc">Competitive Programming / Backend Developer</p>
